...
export class LibroService {
  public apiUrl = 'http://localhost:8090/api/libros';
  public autoresUrl = 'http://localhost:8090/api/autores';
  public editorialesUrl = 'http://localhost:8090/api/editoriales';
  public categoriasUrl = 'http://localhost:8090/api/categorias';
